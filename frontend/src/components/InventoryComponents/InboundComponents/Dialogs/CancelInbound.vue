<template>
    <v-dialog v-model="dialogCancel" max-width="500px" content-class="item-delete-dialog" persistent>
        <v-card class="delete-dialog">
            ...
            <v-card-actions class="delete-btn-wrapper">
                <v-btn class="delete-btn" text @click="cancelConfirm" :disabled="loading">
                    <span v-if="loading">Cancelling...</span>
                    <span v-if="!loading">Cancel Order</span>
                </v-btn>
                <v-btn class="cancel-btn" text @click="close" :disabled="loading">Cancel</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
</template>
