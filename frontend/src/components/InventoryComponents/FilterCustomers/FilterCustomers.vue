        ...
        <v-menu
            ...
            <template v-slot:activator="{ attrs }">
                <v-btn class="btn-white filters" v-bind="attrs" @click="showOrHideOption">
                    ...
                    <span class="ml-1" v-else-if="selectedWhCustomersLists.length > 1" 
                        style="color: #0084BD; font-family: 'Inter-Medium', sans-serif;">
            ...
            <v-card class="filters-card-wrapper" v-click-outside="{handler: clickOutsideFilter,include: includeFunction}">
                    ...
                    <div class="filter-customer-wrapper">
                        ...
                        <v-autocomplete
                            ...
                            <template v-slot:selection="{ item }">
                                <v-chip close @click:close="removeCustomerLists(item, 'single')">
                            ...
                            <template v-slot:item="{ item, on, attrs }">
                                <v-list-item v-on="on" v-bind="attrs" #default="{ active }" @click.stop="setActiveTrue()">
                                    <v-list-item-action>
    ...
    methods: {
        ...
        includeFunction(){
            ...
            if (document.querySelector('.v-select-list')) {
                ...
                return [document.querySelector('.v-select-list')] 
            }else{
                return [document.querySelector('.filter-component-title')] 
            }
        },
        showOrHideOption() {
