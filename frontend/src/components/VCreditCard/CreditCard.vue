			...
			<div class="credit-card-form">
				<div class="field">
					...
					<input
						...
						inputmode="numeric"
						:placeholder="
							this.VCreditCardNumberFormate(
								trans.card.placeholder,
								this.paymentData
							)
						"
						@focus="flipped = false"
				...
				<div class="field-group">
					<div class="field">
						...
						<input
							...
							ref="expiration"
							:placeholder="
								this.VCreditCardExpirationFormate(
									this.paymentData,
									isTwoDigitsYear
								)
							"
					...
					<div class="field">
						...
						<input
							...
							ref="security"
							pattern="[0-9]*"
							:placeholder="this.cardEdit ? '****' : trans.security.placeholder"
							inputmode="numeric"
							@focus="flipped = true"
							:disabled="cardEdit"
						/>
...
export default {
	...
	data() {
		return {
			...
			form: {
				name:
					this.paymentData.first_name !== undefined
	...
	methods: {
		...
		setMasksListeners() {
			...
			this.cardNumberMask.on("accept", () => {
				...
				if (Object.prototype.hasOwnProperty.call(cardTypes, cardName)) {
