							...
							<v-row>
								<v-col cols="12" sm="12" md="7">
									<v-row>
										...
										<v-col cols="12" sm="12" md="4" v-if="shipmentFrequency == 'WEEKLYON'" class="pb-0">
										...
										<v-col cols="12" sm="12" md="4" v-if="shipmentFrequency == 'MONTHLYON'" class="pb-0">
											<label class="text-item-label">Day</label>
											<v-select
												class="text-fields normal-vselect"
												placeholder="Select Day"
										...
										<v-col cols="12" sm="12" md="4" v-if="shipmentFrequency === 'YEARLYON'" class="pb-0">
										...
										<v-col cols="12" sm="12" class="pl-3 pt-1 pb-0 d-flex"
											style="color: #819FB2; font-size: 12px;"
											v-if="shipmentDay === '31' && shipmentFrequency === 'MONTHLYON'">
											<img src="../../assets/icons/info.svg" width="16px" height="16px" style="margin-top: 2px;" />
											<span class="ml-1">
					...
					<div class="box-body">
							...
							<v-col cols="12" sm="12" md="6" class="pb-0">
								<v-row>
									...
									<v-col
										...
										sm="12"
										md="4"
										v-if="shipmentFrequency == 'WEEKLYON'"
										class="pt-0"
									>
										<label class="text-item-label">Day</label>
										<v-select
									...
									<v-col
										...
										sm="12"
										md="4"
										v-if="shipmentFrequency == 'MONTHLYON'"
										class="py-0"
									>
										<label class="text-item-label">Day</label>
										<v-select
									...
									<v-col
										...
										v-if="
											shipmentDay === '31' && shipmentFrequency === 'MONTHLYON'
										"
									>
										<span class="ml-0">
									...
									<v-col
										...
										sm="12"
										md="4"
										v-if="shipmentFrequency === 'YEARLYON'"
										class="pt-0"
									>
										<label class="text-item-label">Date</label>
										<DatePicker
						...
						<v-row>
							<v-col cols="12" sm="12" md="12">
								...
								/>
								<span
									class="error-message caption red--text"
									v-if="errorEmail1"
									>{{ errorEmail1 }}</span
								>
								<span class="error-message caption red--text" v-else>{{
									errorEmails
								}}</span>
								<p class="pt-1 mb-0" style="color: #819FB2; font-size: 12px;">
									Separate multiple email addresses with comma"
								</p>
							</v-col>
						</v-row>
