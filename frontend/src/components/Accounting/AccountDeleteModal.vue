<template>
	<div class="text-center">
		<v-dialog v-model="showDialog" max-width="480" origin="top center" content-class="accounting-module-dialog pa-0" persistent scrollable>
			<v-card :loading="isDeleting" class="account-delete-modal-accounting">
				<v-card-text class="pa-8">
					<v-icon size="52" color="#EB9B26">mdi-alert-circle-outline</v-icon>
					<h2 class="mt-4 mb-3">Delete Account</h2>
					<p>Do you want to delete the account <span>"{{ formData ? formData.name : '' }}"</span>?</p>
...
.account-delete-modal-accounting {
	.v-card__text {
