    ...
    <div class="po-table-wrapper">
        <v-data-table
            ...
            <template v-slot:[`item.supplier_id`]="{ item }">
                ...
                <div class="po-mobile-item dFlex status" v-if="item.status === 'partially shipped'">
                    <v-chip> 
                        {{ item.status !== null ? 
            ...
            <template v-slot:no-data>
                ...
                <div class="no-data-wrapper" v-if="!getPoPendingLoading && posPending.length == 0">
