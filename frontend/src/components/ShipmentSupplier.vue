                ...
                <v-container class="container-wrapper">
                    <v-row style="margin:0px; margin-right: 15%;">
                        <h3 class="supplier-name">
                            {{ (typeof item.name!=='undefined') ? item.name : item.supplier_name }}
                        </h3>
                    </v-row>

                    <div class="po-wrapper">
                        <span v-bind:key="`po-number-${key}`" v-for="({po_number}, key) in poItems" class="po-num-item">
                            {{ 'PO #' +  po_number }}
                        </span>
                    </div>

                    <v-row v-if="!isMobile" class="supplier-desktop-row">
                        <div class="col-sm-2 col-md-2 supplier-col" 
                            v-if="item.total_cartons !== 'undefined' && item.total_cartons !== null && item.total_cartons !== ''">
                        ...
                        <div class="col-sm-12 col-md-2 supplier-col" 
                            v-if="item.cbm !== 'undefined' && item.cbm !== null && item.cbm !== ''">
                        ...
                        <div class="col-sm-12 col-md-2 supplier-col" 
                            v-if="item.kg !== 'undefined' && item.kg !== null && item.kg !== ''">
                        ...
                        <div class="col-sm-12 col-md-3 supplier-col" 
                            v-if="item.ams_num !== 'undefined' && item.ams_num !== null && item.ams_num !== ''">
                        ...
                        <div class="col-sm-12 col-md-3 supplier-col" 
                            v-if="item.hbl_num !== 'undefined' && item.hbl_num !== null && item.hbl_num !== ''">
                        ...
                        <div class="col-sm-12 col-md-2 supplier-col" 
                            v-if="item.incoterm_id !== 'undefined' && item.incoterm_id !== null && item.incoterm_id !== ''">
                        ...
                        <div class="col-sm-12 col-md-2 supplier-col" 
                            v-if="item.bl_status !== 'undefined' && item.bl_status !== null && item.bl_status !== ''">
                        ...
                        <div class="col-sm-12 col-md-8 supplier-col" 
                            v-if="item.product_description !== 'undefined' && item.product_description !== null && item.product_description !== ''">
                    ...
                    <v-row v-if="isMobile" :style="item.po_num !== '' ? 'padding: 10px 0 15px;' : 'padding: 0 0 15px;'">
                        <div class="mobile-supplier-info-wrapper" 
                            v-if="(item.total_cartons !== 'undefined' && item.total_cartons !== null && item.total_cartons !== '') || (item.cbm !== 'undefined' && item.cbm !== null && item.cbm !== '')">
                            <div class="mobile-supplier-info" 
                                v-if="item.total_cartons !== 'undefined' && item.total_cartons !== null && item.total_cartons !== ''">
                                <p class="heading-supplier">Total Cartons</p>
                                <p class="heading-content">
                                    {{ item.total_cartons }}
                        ...
                        <div class="mobile-supplier-info-wrapper" 
                            v-if="(item.kg !== 'undefined' && item.kg !== null && item.kg !== '') || 
                                (item.ams_num !== 'undefined' && item.ams_num !== null && item.ams_num !== '')">
                            <div class="mobile-supplier-info" 
                                v-if="item.kg !== 'undefined' && item.kg !== null && item.kg !== ''">
                                <p class="heading-supplier">Weight</p>
                                <p class="heading-content">
                        ...
                        <div class="mobile-supplier-info-wrapper"
                            v-if="(item.hbl_num !== 'undefined' && item.hbl_num !== null && item.hbl_num !== '') || 
                            (item.incoterm_id !== 'undefined' && item.incoterm_id !== null && item.incoterm_id !== '')">
                            <div class="mobile-supplier-info" 
                                v-if="item.hbl_num !== 'undefined' && item.hbl_num !== null && item.hbl_num !== ''">
                                <p class="heading-supplier">HBL</p>
                                <p class="heading-content">
...
export default {
    ...
    props: ['getDetails', 'isMobile', "shipment_status"],
    data: () => ({
        incoterms: [],
    ...
    async mounted() {
        ...
        //fetch all purchase orders for current viewed shipment
        this.fetchPurchaseOrdersFromShipment()
    },
    methods:{ 
        ...mapActions(["fetchTerms"]),
        getPosBySupplierId(supplier_id) {

            //filter pos from the list of po items
            let po_items = _.filter(this.poItems, e => (e.supplier_id === supplier_id))

            //return po items result
            return po_items
        },
        fetchPurchaseOrdersFromShipment() {
            //fetch shipment purchase order by current viewed shipment
            //pass shipment id
            this.$store.dispatch('po/fetchPosByShipmentId', this.getDetails.id)
        },
        getSupplierTerms(id) {
            if(id) {
    ...
    computed: {
        ...
        poItems() {
            return this.$store.getters['po/getPosShipment']
        },
        productDescription(){
           let productDescription =  []
           this.poItems.map(item => item.products.map(productItem => {
                productDescription.push(productItem.product.product_classification_description)
            }))
            return productDescription.join(", ")
        }
    },
}
</script>
