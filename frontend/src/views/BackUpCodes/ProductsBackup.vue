	...
	<div class="products-wrapper" v-resize="onResize">
		...
		<ConfirmDialog :dialogData.sync="dialogDeleteProduct">
			...
			<template v-slot:dialog_content>
				<p> 
					Do you want to delete the products
					<span class="name">"{{ currentProductToDelete !== null ? currentProductToDelete.name : '' }}"</span>?
...
export default {
	...
	methods: {
		...
		viewProductItem(product) {
			this.editedProductItem = Object.assign({}, product)
