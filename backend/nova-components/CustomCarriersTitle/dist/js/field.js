...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-custom-carriers-title', __webpack_require__(3));
  Vue.component('detail-custom-carriers-title', __webpack_require__(6));
  Vue.component('form-custom-carriers-title', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        $('.title-value').parent().addClass('hidden');
        $('span:contains(' + this.field.name + ')').parent().addClass('hidden');

        var isExist = $('small[class="italic ml-1 text-sm"]');

        isExist.length < 1 ? $('h1[class="mb-3 text-90 font-normal text-2xl"]').removeClass('mb-3') : undefined;
        isExist.length < 1 ? $('h1[class="text-90 font-normal text-2xl"]').after(function () {
            return '<small class="italic ml-1 text-sm">' + _this.field.text + '</small>';
        }) : undefined;
        isExist.length < 1 ? $('small[class="italic ml-1 text-sm"]').next().addClass('mt-3') : undefined;
    }
});
...
var render = function() {
  ...
  return _c(
    "span",
    { staticClass: "title-value", staticStyle: { display: "none" } },
