        ...
        <div class="modal-container">
          ...
          <div class="modal-body mb-4">
            <slot v-bind:item="{item: item, selectFile: selectFile }" name="body">
                ...
                <div v-if="multipleAllow == false" >
                    <input ref="supplierFileHolder" @change="(e) => fileChange(e)"  class="hidden" type="file" id="supplier-file-holder" />
                </div>
                  <div v-else >
...
export default {
  props: ['show', 'item', 'resourceId', 'url', 'token', 'field', 'formGroups', 'multipleAllow'],
  data: () => ({
    documents: [],
    files: [],
      multipleAllow: this.multipleAllow ? this.multipleAllow : true
  }),
  computed: {
    ...mapGetters({
