...
const actions = {
    fetchItems: async ({
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.get(`/nova-vendor/price-check/shipments?${field}&page=${payload.params.page}`)
                .then(res => {
                    if (res.status === 200) {
    ...
    updateRateConfirmed: async ({
        ...
        return axios.post(`/nova-vendor/price-check/shipments/update-rate-confirmed`, bodyFormData)

    },
    fetchShiflOffices: async ({
                           commit
                       }, payload) => {
        return axios.get(`/nova-vendor/price-check/shipments/shifl-offices`)
