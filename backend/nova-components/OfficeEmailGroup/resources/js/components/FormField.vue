        ...
        <div class="flex flex-row">
            <div class="flex flex-col border-b border-40 mx-6 w-1/2">
                ...
                <div v-for="from in froms" class="flex py-4">
                    <div v-if="from.type=='from'" class="w-1/2 flex content-center">
                    ...
                    <div v-if="from.type=='from'" class="w-1/2">
                      <v-select :selectable="(option) => validateOption(option)" taggable push-tags multiple v-model="from.value"></v-select>
                    </div>
                </div>
            </div>
            <div class="flex flex-col border-b border-40 mx-6 w-1/2">
                ...
                <div v-for="to in tos" class="flex py-4">
                    ...
                    <div v-if="to.type=='to'" class="w-1/2">
                      <v-select :selectable="(option) => validateOption(option)" taggable push-tags multiple v-model="to.value"></v-select>
                    </div>
                </div>
            </div>
        </div>
        <div v-if="office_name=='Shifl USA'" class="flex mx-6">
            <div class="flex w-full flex-col">
                ...
                <div v-for="all in alls" class="flex py-4">
                    <div v-if="all.type=='all'" style="width: 20%;">
                        <h4 class="font-bold text-slate-800">
                            {{
                                all.label
                            }}
                    ...
                    <div v-if="all.type=='all'" style="width: 80%;">
                      <v-select :selectable="(option) => validateOption(option)" taggable push-tags multiple v-model="all.value"></v-select>
                    </div>
                </div>
            </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    fill(formData) {
      ...
      formData.append('office_emails', JSON.stringify(newFields))
