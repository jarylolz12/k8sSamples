...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_select_dist_vue_select_css__ = __webpack_require__(19);
...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-office-managers-field', __webpack_require__(3));
  Vue.component('detail-office-managers-field', __webpack_require__(6));
  Vue.component('form-office-managers-field', __webpack_require__(9));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getAllManagers: function getAllManagers() {
      ...
      fetch(this.base_url + '/custom/account-managers').then(this.handleResponse).then(function (response) {
        var results = response.results;

        _this.managers = results;
      }).catch(function (e) {
        console.log(e);
      });
    },
  ...
  return _c(
    "default-field",
    {
      attrs: {
        field: _vm.field,
        errors: _vm.errors,
        id: "hide-account-manager-select-id"
      }
    },
    [
      _c("template", { slot: "field" }, [
        _c(
          ...
          [
            _c("v-select", {
              ...
              model: {
                value: _vm.managers_lists,
                callback: function($$v) {
                  _vm.managers_lists = $$v
                },
                expression: "managers_lists"
              }
            })
          ],
          1
        ...
        _c("div", [
          _vm._v(
            "\n          " +
              _vm._s(
                typeof _vm.errors !== "undefined" &&
                  typeof _vm.errors.managers_lists !== "undefined"
                  ? _vm.errors.managers_lists
                  : ""
              ) +
              "\n        "
          )
