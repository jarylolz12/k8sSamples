<template>
    <form-invoice-modal-wrapper
        :dynamic="dynamic"
        id="form-invoice-modal-wrapper">
        <template v-slot:content="dnamic">
            <div class="flex flex-col">
                <div class="flex flex-row w-full pb-4">
                    <div class="w-1/3 flex-col">
                        <div class="flex flex-col pb-6">
                            <label
                                class="pb-2 inline-block text-80 leading-tight"
                            >
                                QB Customer
                            </label>
                            <customer-search-box-wrapper
                                id="customer-search-box-wrapper-id"
                            >
                                <template v-slot:content>
                                    <customer-search-box
                                        ...
                                        :initCustomerValue="
                                            qboCustomerInfo.realm_id ===
                                            $store.state.chargesTab.qboCompanyInfo.realm_id ? qboCustomerInfo : []
                                        "
                                        :isAddInvoice="true"
                                    ></customer-search-box>
                                </template>
                        ...
                        <div class="flex flex-col pb-6">
                            ...
                            <div class="flex flex-row">
                                ...
                                <div class="pl-2 italic content-center">
                                    {{
                                        "If multiple emails, separate by comma"
                                    }}
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col pb-6">
                            ...
                            <customer-search-box-wrapper id="terms-wrapper-id">
                                <template v-slot:content>
                                    <v-select
                                        class="termSelect"
                                        v-if="terms.length > 0"
                        ...
                        <div class="flex flex-col pb-6 d-none">
                            <label
                                class="pb-2 inline-block text-80 leading-tight"
                            >
                                Notes
                            ...
                            <div class="pb-2">
                                <textarea
                                    rows="10"
                                    class="w-full form-control form-control-sm form-input form-input-bordered h-auto customer-memo-textarea"
                                    v-model="qbCustomerMemo"
                                ></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="w-1/3 flex-col pl-4">
                        ...
                        <div class="flex flex-col pb-8 invoice-number-wrapper">
                            <label
                                class="pb-2 inline-block text-80 leading-tight"
                            >
                                Invoice #
                            ...
                            <div class="pb-2">
                                <input
                                    type="text"
                                    v-model="qbInvoiceNumber"
                                    class="form-control form-input form-input-bordered w-full"
                                />
                            </div>
                        </div>
                        <div class="flex flex-col invoice-date-group">
                            <label
                                class="pb-2 inline-block text-80 leading-tight"
                            >
                                Invoice Date
                    ...
                    <div class="w-1/3 flex-col pl-4">
                        <div style="padding-bottom: 9px;" class="flex flex-col">
                            <label
                                class="pb-2 inline-block text-80 leading-tight"
                            >
                                Billing Address
                            ...
                            <div class="pb-2">
                                <input
                                    type="text"
                                    v-model="qbCustomerBillingAddress"
                                    class="form-control form-input form-input-bordered w-full"
                                />
                            </div>
                        </div>
                        <div class="flex flex-col pb-8 due-date-wrapper">
                            <label
                                class="pb-2 inline-block text-80 leading-tight"
                            >
                                Due Date
                ...
                <div class="flex flex-col w-full">
                    <div class="w-full font-bold services-section-wrapper">
                        Services Section
                    </div>
                    <div class="flex">
                        <div v-if="qboCompanyInfo.Country === 'IN'">
                            <india-services-section
                                ...
                                :initServiceSectionValue="servicesSectionValue"
                    ...
                    <div class="flex">
                        <div class="flex mt-6">
                            <div class="flex flex-row">
                                <div class="flex px-2">
                                    <button-wrapper id="button-interaction-wrapper-5">
                                        <template v-slot:content>
                                            <button
                                ...
                                <div class="flex px-2">
                                    <div>
                                        <button-wrapper id="button-interaction-wrapper-4">
                                            <template v-slot:content>
                                                <button
                                ...
                                <div class="flex px-2">
                                <button-wrapper id="button-interaction-wrapper-2">
                                    <template v-slot:content>
                                        <button
                                            type="button"
...
import CustomerSearchBoxWrapper from "./StyleWrappers/CustomerSearchBoxWrapper";
import FormInvoiceModalWrapper from "./StyleWrappers/FormInvoiceModalWrapper";
...
import ButtonWrapper from "./StyleWrappers/ButtonWrapper";
...
export default {
    ...
    components: {
        ...
        FormInvoiceModalWrapper,
        CustomerSearchBoxWrapper,
        FontAwesomeIcon
    },
    computed: {
        ...mapGetters({
        ...
        common_errors: [
            {
                ...
                alias:
                    "Invoice number must be at least 8 characters long and not more than 21 characters"
            },
            {
                error:
                    "String length specified does not match the supported length. Min:0 Max:21 supported. Supplied length:33",
                alias:
                    "Invoice number must be at least 8 characters long and not more than 21 characters"
            },
            {
    ...
    created() {
        ...
        if ( this.resourceId!=null ) {
                ...
                .then(response => {
                    ...
                    if(Object.keys(result).length > 0 ){
                       ...
                       //set Initial Modal Value
                        ...
                        this.setServicesSectionValue(result.invoice_services)
                        setTimeout(() => {
                            this.dynamic = 5
                        },15000)
            ...
            axios
            .get("/custom/shipment/get-for-invoice?id=" + this.resourceId)
            .then(response => {
                const result = response.data.result;
                if (result) {
                    let mbl_num = result.mbl_num ? result.mbl_num : "";
                    let po_nums = result.po_numbers ? result.po_numbers : "";
                    let containers = result.container_numbers
                        ? result.container_numbers
                        : "";
                    let etd = result.etd
                        ? moment.utc(result.etd).format("MM/DD/YYYY")
                        : "";
                    let eta = result.eta
                        ? moment.utc(result.eta).format("MM/DD/YYYY")
                        : "";
                    let location_from = result.location_from
                        ? result.location_from
                        : "";
                    let location_to = result.location_to
                        ? result.location_to
                        : "";
    ...
    methods: {
        ...mapActions({
            ...
            setShowNotes: 'page/setShowNotes'
        }),
        toggleAutoInvoiceDate() {
            ...
            if (value) {
                ...
                if (value.PrimaryEmailAddr) {
                    ...
                    if (
                        ...
                        value.Id == parseInt(this.defaultCustomer.qbo_id)
                    ) {
        ...
        consCustomerBillingAddr(customerDetails) {
            let billAddr = customerDetails.BillAddr
                ? customerDetails.BillAddr
                : {};

            let billerName = `${
                customerDetails.GivenName ? customerDetails.GivenName : ""
            } ${
        ...
        onTermSelect(value) {
            ...
            let buildDate = moment(
                this.qbCustomerInvoiceDate,
                "YYYY-MM-DD"
            ).add(parseInt(this.qbTermDueDays), "days");
        ...
        handleUploadAttachment: function(
            qbo_invoice_id,
            invoice_id,
            attachment,
            isSaveNSend
            ...
            if (
                (this.attachments.files && this.attachments.files.length > 0) ||
                this.shipmentDocs.length > 0
            ) {
                if (isSaveNSend) {
                ...
                axios
                    .post("/custom/qbo/attachable/upload", formData, {
                    ...
                    .then(response => {
                        if (response.data.success === true) {
                            ...
                            Nova.error(
                                "Failed to upload file(s). Please check if it exists."
                            );
        ...
        getShipmentDocuments: function() {
            axios
                .get(
                    "/custom/qbo/attachable/get-shipment-documents/" +
                        this.resourceId
                )
                .then(response => {
                    if (response.data.success === true) {
                        ...
                        result.map(function(o) {
                            attachable.push(
                                o.commercial_documents,
                                o.commercial_invoice,
                                o.packing_list,
                                o.hbl_copy
                            );
                        });
        ...
        getShipmentCommecialDocuments: function() {
            axios
                .get(
                    "/custom/qbo/attachable/get-shipment-commercial-documents/" +
                        this.resourceId
                )
                .then(response => {
                    if (response.data.success === true) {
        ...
        autoGenerateInvoiceNumber: function() {
            axios
                .get("/custom/invoice/generate-invoice-num/" + this.resourceId)
                .then(response => {
                    if (response.data.success === true) {
        ...
        onSaveInvoice: function(isSaveNSend) {
            ...
            let filteredServiceItems = _.reject(this.serviceItems, function(o) {
                return _.isNull(o.Service);
            });

            let buildUrl = this.isAddInvoice ? '/custom/qbo/invoice/add' : '/custom/qbo/invoice/edit'

            let passedParameters = this.isAddInvoice ? {
                    customerId: this.qbCustomerId,
                    line: filteredServiceItems,
                    auto_invoice_date_update: this.autoInvoiceDateUpdate
                        ? 1
                        : 0,
            ...
            axios
                .post(buildUrl, passedParameters)
                .then(response => {
                    if (response.data.success === true) {
                        ...
                        if (e.indexOf("<?xml") != -1) {
                            ...
                            if (
                                this.common_errors.findIndex(
                                    i => i.mark == 0
                                ) == -1
                            ) {
                                this.common_errors = this.common_errors.map(
                                    i => {
                                        i.mark = 0;
                            ...
                            for (
                                var i = 0;
                                i < xml.getElementsByTagName("Error").length;
                                i++
                            ) {
                                var q = this.common_errors.findIndex(
                                    item =>
                                        item.error ===
                                        xml
                                            .getElementsByTagName("Error")
                                            [i].querySelector("Message")
                                            .textContent
                                );
                                ...
                                Nova.error(
                                    xml
                                        .getElementsByTagName("Error")
                                        [i].querySelector("Detail").textContent
                                );
                            }
                        } else {
                            Nova.error(e);
        ...
        sendInvoiceByQBO: function(invoice_id) {
            ...
            formData.append(
                "auto_invoice_date_update",
                this.autoInvoiceDateUpdate ? 1 : 0
            );
            axios
                .post("/custom/qbo/invoice/send-invoice", formData)
                .then(response => {
                    if (response.data.success === true) {
        ...
        getExchangeRate: function(customerCurrencyCode) {
            ...
            let targetCurrencyCode =
                typeof activeCompany !== "undefined"
            ...
            if (targetCurrencyCode !== "") {
                axios
                    .get(
                        "/custom/qbo/exchangerate/get-by-currency-codes?sourceCurrencyCode=" +
        ...
        getUpdatedCustomerEmail() {
            if (this.qboCustomerInfo.customer.Id) {
                axios
                    .get(
                        "/custom/qbo/customer/get-udated-customer-email/" +
                            this.qboCustomerInfo.customer.Id
                    )
                    .then(response => {
                        if (response.data.result !== null) {
                            let customerEmails =
                                response.data.result.PrimaryEmailAddr;

                            let final_email = customerEmails.Address;
                            if (this.salesRepresentative != null) {
                                final_email +=
                                    "," + this.salesRepresentative.email;
                            }
                            this.qbCustomerEmail = final_email;
                        }
                    })
    ...
    watch: {
        ...
        terms: function(newVal, oldVal) {
            let termDefaultValue = _.filter(this.terms, function(c) {
                return parseInt(c.DueDays) === 0;
            });
    ...
    mounted() {
        ...
        if ( this.resourceId!=null && !this.isAddInvoice ) {
