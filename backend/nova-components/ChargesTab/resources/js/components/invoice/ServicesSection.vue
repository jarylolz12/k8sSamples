<template>
    <div>
        ...
        <button-wrapper id="button-interaction-wrapper">
            <template v-slot:content>
                <div class="mt-2">
                    <button
                     style="border-radius: 0px;"
                     class="btn-add-item btn btn-default btn-sm inline-flex items-center mr-3 btn-default"
...
import ButtonWrapper from './StyleWrappers/ButtonWrapper.vue';
...
export default {
    ...
    props: ["resourceId","initServiceSectionValue","edit", "selectedInvoiceQBOId","exchangeRateValue","dynamic"],
    data:() =>({
       itemGroup:[],
       serviceValue:{},
       serviceOptions: [],
    ...
    updated() {
        if ( this.itemGroup!= this.serviceSectionValue ) {
            this.itemGroup = this.serviceSectionValue
        }
    },
    ...
    created() {
        //this.serviceSectionValue = this.initServiceSectionValue
    ...
    computed: {
        ...
        serviceSectionValue() {
            let itemGroup = []
            if( this.getServicesSectionValue.length > 0 ){
                let setId = new Date().getTime();
                //console.log(this.initServiceSectionValue);
                this.getServicesSectionValue.map(o => {
                    itemGroup.push({
                        id: o.id,
                        invoice_item_id:o.id,
                        Service:{"Id":o.qbo_service_id,"Name":o.qbo_service_name},
