...
export default {
    ...
    data() {
        return {
            ...
            gridCustAdapter:{},
            // gridCustAdapter: new jqx.dataAdapter(this.gridCustSource,{
            //     formatData: (data) => {
            ...
            columns: [
                ...
                { text: 'Amount', datafield: 'Amount', width:80},
                {
                    ...
                    createeditor: (row, value, editor) => {
                        let vm = this;
                        editor.jqxComboBox({ 
                            //source: vm.gridCustAdapter,
                            source: new jqx.dataAdapter({datatype: 'array',datafields:[{ name: 'FullyQualifiedName', type: 'string' },{ name: 'Id', type: 'string' }],localdata:[]}),
                            displayMember: 'FullyQualifiedName',
                            valueMember: 'Id',
                            placeHolder: 'Search Customer',
                            remoteAutoComplete : true,
                            search: function (searchString){
                                //vm.searchCustomer(searchString)
                                if(searchString){
                                    //console.log('searchString: '+searchString);
                                    console.log(vm.gridCustAdapter);
                                    ...
                                    .then(response => {
                                        ...
                                        for (x=0;x<=2;x++){
                                            ...
                                            this.source = new jqx.dataAdapter(gridCustSource);
                                        }
                                        this.open()
                                    })
                                    .catch(e=>{
    ...
    beforeCreate: function () {
        ...
        this.source = {
            ...
            datafields: [
                ...
                { text: 'Customer', values: { source: this.gridCustAdapter.records, value: 'Id', name: 'FullyQualifiedName' } },
            ],
            id: 'id',
    ...
    methods: {
        ...
        searchCustomer(searchString){
            ...
            console.log(this.gridCustAdapter)
        },
