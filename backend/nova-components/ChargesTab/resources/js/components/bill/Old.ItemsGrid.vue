...
import { beverages, services } from '../parts/modals/data.js'
//window.$ = jQuery
...
export default {
    ...
    data() {
        return {
            ...
            columns: [
                {
                    text: 'Product/Service', with:250, dataField: 'ServiceId', displayField: 'Service', columnType: 'combobox',
                    createeditor: (row, value, editor) => {
                         editor.jqxComboBox({ source: this.servicesAdapter, displayMember: 'Name', valueMember: 'Id' });
                     }
                },{
                    text: 'SKU', with:80, dataField: 'Sku', displayField: 'Sku',  
                },{
                    text: 'Description', with:80, dataField: 'Description',  
                },{
                    text: 'Qty', with:80, dataField: 'QtyOnPurchaseOrder',  
                },{
                    text: 'Rate', with:80, dataField: 'RatePercent',
                },{
                    text: 'Amount', with:80, dataField: 'Amount', 
                },{
                    text: 'Billable', with:80, dataField: 'Billable', 
                },{
                    text: 'Taxable', with:80, dataField: 'Taxable',
                },{
                    text: 'Customer/Project', with:80, dataField: 'Customer',  
                },{
                    text: 'Class', with:80, dataField: 'Class',  
                }
