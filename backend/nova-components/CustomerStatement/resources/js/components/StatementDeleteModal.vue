         ...
         <div class="justmodal-container" @click.stop>
            ...
            <div class="justmodal-content">
               <div class="mb-6 pl-3 pr-3 text-center">
                  ...
                  <h3>Are you sure you want to delete this record? click 'Confirm' to proceed.</h3>
               </div>
               <div class="text-center">
                  <a href="#" @click.prevent="save()" class="btn btn-default btn-primary inline-flex items-center m-5" dusk="create-button" style="height: 2.12rem;">
                     Confirm
                  </a>
                  <a href="#" @click.prevent="open = false" class="btn btn-default btn-outlined inline-flex items-center m-5" dusk="create-button" style="height: 2.12rem; border: 1px solid #ccc; color: #242424; text-shadow: none;">
                     Cancel
                  </a>
               </div>
            </div>
      ...
      methods: {
         async save(is_send) {
            try {
               ...
               const { data } = await axios.post('/nova-vendor/customer-statement/statement/delete/',{
                  id: this.formData.statement_real_id
               });
