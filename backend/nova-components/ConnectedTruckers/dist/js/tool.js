...
Nova.booting(function (Vue, router, store) {
  Vue.component('connected-truckers', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/nova-vendor/connected-truckers?customer_id=' + this.resourceId).then(function (res) {
      if (res.status == 200) {
        _this.truckers = res.data;
      }
    });
  },
  data: function data() {
  ...
  computed: {
    totalTruckers: function totalTruckers() {
                  ...
                  [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.truckers, function(trucker, index) {
                            return _c(
                              "tr",
                              { key: trucker.id, attrs: { dusk: "43448-row" } },
                              [
                                _c("td", [
                                  _vm._v(
                                    "\n\t\t\t\t\t\t\t\t\t" +
                  ...
                  [
                    _c(
                      ...
                      [
                        _c("button", {
                          staticClass:
                            "btn btn-link py-3 px-4 text-80 opacity-50",
                          attrs: {
                            disabled: "disabled",
                            rel: "prev",
                            dusk: "previous"
                        ...
                        _c(
                          "span",
                          { staticClass: "text-sm text-80 px-4 py-2" },
                          [
                            _vm._v(
                              " " +
                                _vm._s(_vm.totalTruckers > 0 ? 1 : 0) +
                                " - " +
                                _vm._s(_vm.totalTruckers) +
                                " of " +
                                _vm._s(_vm.totalTruckers) +
                                " "
                            )
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticClass: "text-left" }, [_c("span")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-left" }, [_c("span", [_vm._v("Name")])]),
        _vm._v(" "),
        _c("th", { staticClass: "text-left" }, [_c("span", [_vm._v("Email")])]),
        _vm._v(" "),
        _c("th", [_vm._v(" ")])
      ])
    ])
