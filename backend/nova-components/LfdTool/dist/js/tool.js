...
var update = __webpack_require__(17)("6e5db1d0", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_good_table_dist_vue_good_table_css__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_good_table__ = __webpack_require__(28);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    // add to component
    components: {
        VueGoodTable: __WEBPACK_IMPORTED_MODULE_2_vue_good_table__["a" /* VueGoodTable */]
    },
    data: function data() {
        var _this = this;
        ...
        return {
            columns: [{
                ...
                field: function field(row) {
                    return _this.strLimit(row.lfd_notes, 30, '...');
                },
                sortable: false
            }, {
                label: 'Last Free Day',
                field: 'pickup_lfd',
                type: 'date',
                formatFn: function formatFn(value) {
    ...
    computed: {
        filtered_rows: function filtered_rows() {
            var _this2 = this;

            if (this.selectedFilter == 'all') {
                if (this.selectedTrackingSourceFilter == 'all') return this.rows;
                return this.rows.filter(function (row) {
                    return row.tracking_source == _this2.selectedTrackingSourceFilter;
                });
            }
            return this.rows.filter(function (row) {
                return (_this2.selectedFilter == 'reviewed' ? row.is_reviewed : !row.is_reviewed) && (_this2.selectedTrackingSourceFilter == 'all' ? true : row.tracking_source == _this2.selectedTrackingSourceFilter);
            });
        }
    },
    ...
    methods: {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                this.loading = true;
                                _context.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get("/nova-vendor/lfd-tool/shipments").then(function (res) {
        ...
        goToDetailView: function goToDetailView(row) {
            this.$router.push('/resources/shipments/' + row.id + '?tab=' + (row.tracking_source == 'Manual' ? 'manual-tracking-tab' : 't49-tracking'));
        },
        sortLfd: function sortLfd(x, y, col, rowX, rowY) {
        ...
        markAsReviewed: function () {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post("/nova-vendor/lfd-tool/shipments/mark-as-reviewed/" + row.mbl_num + '/' + row.container_num, {
                                    shifl_ref: row.shifl_ref,
                                    tracking_source: row.tracking_source
                                }).then(function (res) {
                                    _this4.loadData();
                                    Nova.success("Container#" + container_num + " has been marked as Reviewed!");
                                }).catch(function (err) {
                                    console.log(err);
                                });
            ...
            function markAsReviewed(_x) {
                return _ref2.apply(this, arguments);
            }

            return markAsReviewed;
        }(),
        addNotes: function addNotes(row) {
            this.note = {
                shifl_ref: row.shifl_ref,
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _context3.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post("/nova-vendor/lfd-tool/shipments/add-notes", this.note).then(function (res) {
                                    _this5.loadData();
                                    Nova.success("Notes Saved!");
                                    _this5.showNotes = false;
                                    _this5.saveText = 'Save';
                                }).catch(function (err) {
                                    console.log(err);
                                    _this5.showNotes = false;
                                    _this5.saveText = 'Save';
        ...
        notifyDemurrage: function () {
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                this.loading = true;
                                _context4.next = 3;
                                return __WEBPACK_IMPORTED_MODULE_3_axios___default.a.post("/nova-vendor/lfd-tool/shipments/notify-demurrage/" + id).then(function (res) {
                                    _this6.loading = false;

                                    Nova.success(res.data.message);
                                }).catch(function (err) {
                                    console.log(err);
                                    _this6.showNotes = false;
                                    _this6.saveText = 'Save';
                                });
            ...
            function notifyDemurrage(_x2) {
                return _ref4.apply(this, arguments);
            }

            return notifyDemurrage;
        }(),
        strLimit: function strLimit(text, count, suffix) {
            return text.slice(0, count) + (text.length > count ? suffix : "");
        },
        csvExport: function csvExport() {
            var rows = [['Shifl Ref', 'MBL', 'Container', 'Last free day']].concat(_toConsumableArray(this.rows.map(function (row) {
                return [row.shifl_ref, row.mbl_num, row.container_num, row.pickup_lfd];
            })));
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __vue_component__$6; });
/**
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("heading", { staticClass: "mb-6" }, [_vm._v("LFD Tool")]),
          _vm._v(" "),
          !_vm.loading
            ? _c(
                "button",
                {
                  staticClass: "btn btn-default btn-primary ml-2",
                  staticStyle: {
                    "font-size": "14px",
                    "line-height": "2rem",
                    zoom: "0.90"
      ...
      !_vm.loading
        ? _c(
            ...
            [
                      ...
                      [
                        _c("div", { staticClass: "container" }, [
                          _c(
                            ...
                            [
                              _c("div", { staticClass: "w-1/4 px-8 py-4" }, [
                                _c(
                                  "label",
                                  {
                                    staticClass:
                              ...
                              _vm._v(" "),
                              _c("div", { staticClass: "py-4 px-8 w-3/4" }, [
                                _c("div", { staticClass: "pt-2" }, [
                                  _vm._v(
                                    "\n                                " +
                                      _vm._s(_vm.note.shifl_ref || "N/A") +
                                      "\n                            "
                                  )
                                ])
                              ])
                            ...
                            [
                              ...
                              _c("div", { staticClass: "py-4 px-8 w-3/4" }, [
                                _c("div", { staticClass: "pt-2" }, [
                                  _vm._v(
                                    "\n                                " +
                                      _vm._s(_vm.note.container_num || "N/A") +
                                      "\n                            "
                                  )
                                ])
                              ])
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.note.notes,
                                        expression: "note.notes"
                                      }
                                    ],
                                    staticClass:
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "btn-sm btn-default btn-info ml-2",
                                  staticStyle: {
                                    "font-size": "14px",
                                    "line-height": "2rem",
                                    background: "#e3e8ee"
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "btn-sm btn-default btn-primary ml-2",
                                  staticStyle: {
                                    "font-size": "14px",
                                    "line-height": "2rem"
                                  },
              ...
              _c(
                "div",
                { staticClass: "pt-2 border-b border-50" },
                [
                  _c("div", { staticClass: "pt-2 border-b border-50" }, [
                    _c("div", { staticClass: "flex justify-end pb-2" }, [
                      _c("div", { staticClass: "flex bg-10 rounded" }, [
                        _c("div", [
                          _c("div", { staticClass: "p-2" }, [
                            _c(
                              "select",
                              {
                                ...
                                staticClass:
                                  "block w-full form-control form-select cursor-pointer",
                                attrs: {
                                  dusk:
                                    "Filter by Account Manager-filter-select"
                                },
                                on: {
                                  change: function($event) {
                        ...
                        _c("div", [
                          _c("div", { staticClass: "p-2" }, [
                            _c(
                              "select",
                              {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.selectedTrackingSourceFilter,
                                    expression: "selectedTrackingSourceFilter"
                                  }
                                ],
                                staticClass:
                                  "block w-full form-control form-select cursor-pointer",
                                ...
                                on: {
                                  change: function($event) {
                                    ...
                                    _vm.selectedTrackingSourceFilter = $event
                                      .target.multiple
                                      ? $$selectedVal
                                      : $$selectedVal[0]
                                  }
                              ...
                              _vm._l(_vm.trackingSourceOptions, function(
                                option
                              ) {
                                return _c(
                                  "option",
        ...
        : _c(
            "card",
            { staticClass: "flex border-b border-40 p-8" },
            [_c("loader", { staticClass: "text-60 text-center" })],
            1
          )
    ],
    1
