...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-crux-containers-detail', __webpack_require__(12));
  Vue.component('detail-crux-containers-detail', __webpack_require__(15));
  Vue.component('form-crux-containers-detail', __webpack_require__(36));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	mounted: function mounted() {
		...
		containers.forEach(function (container) {
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get("/custom-api/crux-container-detail/" + container.container_num).then(function (response) {
				_this.containers.push(response.data.crux_container);
			});
		});
	}
});
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c(
      ...
      [
        _vm.containers.length == 0 || _vm.containers == ""
          ? _c("div", [
              _c("div", [
                _vm._v(
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm._l(_vm.containers, function(item, key) {
          return _c(
            "div",
            {
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: _vm.containers.length > 0,
                  expression: "containers.length>0"
                }
              ],
              staticClass: "shipment-container-group"
            },
            [
              _c("div", [
              ...
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Container #")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(
                      item.container_num == null ? "N/A" : item.container_num
                    )
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Customs Hold")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(
                      item.customs_hold == null ? "N/A" : item.customs_hold
                    )
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Line Hold")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(item.line_hold == null ? "N/A" : item.line_hold)
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Firm's Code")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(item.firms_code == null ? "N/A" : item.firms_code)
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                ...
                _vm._v(" "),
                _c("span", [
                  _vm._v(_vm._s(item.eta == null ? "N/A" : item.eta))
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Return Text")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(item.return_text == null ? "N/A" : item.return_text)
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Discharged At")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(
                      item.discharged_at == null ? "N/A" : item.discharged_at
                    )
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Last Free Day")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(
                      item.last_free_day == null ? "N/A" : item.last_free_day
                    )
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Departed At")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(item.departed_at == null ? "N/A" : item.departed_at)
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", [
                _c("label", [_vm._v("Returned At")]),
                _vm._v(" "),
                _c("span", [
                  _vm._v(
                    _vm._s(item.returned_at == null ? "N/A" : item.returned_at)
                  )
                ])
              ])
            ]
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_nova__ = __webpack_require__(38);
