...
return [
    'configs' => [
        [
            ...
            // 'signature_validator' => App\Handler\EntryWebhookSignatureValidator::class,
            'signature_validator' => App\Handler\EntryWebhookSignatureValidator::class,
            ...
            'webhook_model' => App\EntryWebhook::class,
             ...
             */
            'process_webhook_job' => App\Handler\EntryWebhookHandler::class,
        ],
    ],
];
