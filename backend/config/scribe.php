...
return [
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                // '/health', 'admin.*'
                // '/api/sell-buy-rates-index/data/get/graph/terminal',
                // '/api/sell-buy-rates-index/data/get/indexes/terminal',
                //'/api/sell-buy-rates-index/data/get/container/{id}',
                //  '/api/sell-buy-rates-index/data/get/indexes/{id}',
            ],
    ...
    'auth' => [
         ...
         * visiting your dashboard and clicking <b>Generate API token</b>
         */
        'extra_info' => 'You can retrieve your token by login your credentials and get  <b>Generate API token</b> or by visiting your dashboard and clicking <b>Generate API token</b>.',
    ],
