...
use App\Events\SendBookingEmailConfirmedByCustomerEvent;
...
class SendBookingEmailConfirmedByCustomerEventListener
{
    /**
     ...
     * Handle the event.
     *
     * @param  SendBookingEmailConfirmedByCustomerEvent  $event
     * @return void
     */
    public function handle(SendBookingEmailConfirmedByCustomerEvent $event)
    {
        //\Debugbar::info('hello');
       ...
       // $cc = [];
        ...
        $subjects = sprintf('Booking Confirmed by Customer, Reference Number - %d', $shipment->shifl_ref);
        ...
        if ( isset($shipment->customer)){
            ...
            if ( $sendToDefault ) {
                if (isset($shipment->customer->emails) && is_array($shipment->customer->emails)) {
                    if ( count($shipment->customer->emails) > 0 ) {
