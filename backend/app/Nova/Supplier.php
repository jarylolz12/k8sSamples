...
use Imbhavin95\SupplierConnect\SupplierConnect;
...
class Supplier extends Resource
{
    ...
    public function fields(Request $request)
    {
        ...
        return [
            ...
            SupplierConnect::make('')->initFields(
                ['supplierId' => $this->id, 'customerId' => $customerId, 'connectedCustomerId' => $this->connected_customer]
            )->onlyOnIndex(),
