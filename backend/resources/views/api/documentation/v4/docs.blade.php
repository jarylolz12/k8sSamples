...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    @include('api.documentation.v4.sidebar.index')
                    ...
                    <div class="right-bar">
                        ...
                        <div class="com-container">
                            ...
                            <div id="structure" class="com-container">
                                ...
                                <div class="row p-t-10" id="purchase-order">
                                    ...
                                    @include('api.documentation.v4.endpoints.get-purchase-order')
                                    @include('api.documentation.v4.endpoints.create-purchase-order')
                                    @include('api.documentation.v4.endpoints.update-purchase-order')
                                    @include('api.documentation.v4.endpoints.delete-purchase-order')
